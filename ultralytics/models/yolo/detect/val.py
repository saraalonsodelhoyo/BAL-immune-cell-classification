...
class DetectionValidator(BaseValidator):
    ...
    def get_desc(self):
        ...
        return ("%22s" + "%11s" * 7) % ("Class", "Images", "Instances", "Box(P", "R", "F1", "mAP50", "mAP50-95)") # OWN MODIFICATION: Added F1 score
        # OLD VERSION: return ("%22s" + "%11s" * 6) % ("Class", "Images", "Instances", "Box(P", "R", "mAP50", "mAP50-95") # Original version

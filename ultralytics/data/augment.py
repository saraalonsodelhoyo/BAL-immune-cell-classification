...
class Albumentations:
    ...
    def __init__(self, p=1.0):
        ...
        try:
            ...
            # Transforms
            T = [
                A.Blur(p=0.0), # OWN MODIFICATION: Set the probability to zero, previously p=0.01
                A.MedianBlur(p=0.0), # OWN MODIFICATION: Set the probability to zero, previously p=0.01
                A.ToGray(p=0.0), # OWN MODIFICATION: Set the probability to zero, previously p=0.01
                A.CLAHE(p=0.0), # OWN MODIFICATION: Set the probability to zero, previously p=0.01
